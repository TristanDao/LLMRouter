...
Usage:
    1. Create a directory for project routers (e.g., ./my_routers/)
...
def discover_and_register_plugins(
    ...
    if plugin_dirs is None:
        ...
        # Default location 1: ./my_routers/ (relative to current directory)
        if os.path.exists("my_routers"):
            plugin_dirs.append("my_routers")
